...
/** @param {NS} ns */
function getBestSkill(ns: NS, blackOpsCompleted) {
  const b = ns.bladeburner;
...
/** @param {NS} ns */
function getBladeburnerGeneralInfo(ns: NS) {
  const b = ns.bladeburner;
...
/** @param {NS} ns */
function printTable(ns: NS, title, data) {
...
function pretty_print(ns: NS, data) {
